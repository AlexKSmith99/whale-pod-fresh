        ...
        <View style={styles.content}>
          <View style={styles.iconContainer}>
            <View style={[
              ...
              <Ionicons name="document-text-outline" size={26} color={isNewTheme ? colors.textSecondary : editorial.muted} />
            </View>
          </View>
          ...
          <View style={[styles.infoCard, { backgroundColor: colors.surface, borderColor: colors.border }, !isNewTheme && styles.editorialCard]}>
            ...
            <Text style={[styles.cardTitle, { color: colors.textSecondary }, isNewTheme ? styles.darkLabel : styles.editorialLabel]}>You have been removed from</Text>
            ...
            <Text style={[styles.dateText, { color: colors.textTertiary }]}>on {formatDate(removedAt)}</Text>
          </View>
          ...
          <View style={[styles.reasonCard, { backgroundColor: colors.surface, borderColor: colors.border }, !isNewTheme && styles.editorialCard]}>
            ...
            <Text style={[styles.reasonLabel, { color: colors.textSecondary }, isNewTheme ? styles.darkLabel : styles.editorialLabel]}>Reason provided by the creator</Text>
