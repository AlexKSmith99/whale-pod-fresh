...
export default function TimeSlotProposalScreen({ pursuitId, pursuitTitle, onClose, onSubmitted }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      AppAlert.alert('Success!', 'Your time proposals have been submitted', [
        { text: 'OK', onPress: () => {
          onSubmitted();
          onClose();
        }}
      ...
      AppAlert.alert('Error', error.message || 'Failed to submit time proposals');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[
        ...
        <Text style={[styles.headerTitle, { color: colors.textPrimary, fontFamily: isNewTheme ? 'Sora_700Bold' : 'PlayfairDisplay_700Bold' }, light && { letterSpacing: -0.5 }]}>Propose Meeting Times</Text>
        <View style={{ width: 28 }} />
      </View>
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.content}>
          <View style={[
            ...
            light && { borderWidth: 1, borderColor: editorial.hairline, borderRadius: 14, paddingLeft: 22, overflow: 'hidden', ...shadows.none },
          ]}>
          ...
          {timeSlots.map((slot, index) => (
            <View key={index} style={[
              ...
              >
                ...
                <Text style={[styles.pickerButtonText, styles.pickerButtonTextSelected, { color: colors.textPrimary, fontFamily: isNewTheme ? 'Sora_600SemiBold' : 'InterTight_600SemiBold' }]}>
              ...
              <View style={styles.timeRow}>
                <View style={styles.timeInput}>
                  ...
                  >
                    ...
                    <Text style={[styles.pickerButtonText, styles.pickerButtonTextSelected, { color: colors.textPrimary, fontFamily: isNewTheme ? 'Sora_600SemiBold' : 'InterTight_600SemiBold' }]} numberOfLines={1} adjustsFontSizeToFit>
