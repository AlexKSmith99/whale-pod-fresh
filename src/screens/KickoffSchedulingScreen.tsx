              ...
              <View style={styles.legendItems}>
                {proposals.map((proposal) => (
                  <View key={proposal.user_id} style={styles.legendItem}>
                    ...
                    <Text style={styles.legendText}>{proposal.user?.name || proposal.user?.email || 'Team member'}</Text>
                  </View>
                ))}
              </View>
            </View>
                        ...
                        <View style={styles.teamMembersRow}>
                          {slots.map((slot, idx) => (
                            <View key={idx} style={styles.memberBadge}>
                              ...
                              <Text style={styles.memberName}>{slot.proposer?.name || slot.proposer?.email || 'Team member'}</Text>
                            </View>
                          ))}
                        </View>
                        {slots.length > 1 && (
